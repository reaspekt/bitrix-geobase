...
class MaxmindRepo implements DatabaseInterface
{
     ...
     public static function checkLatestVersion(): string
     {
          $isLastVersion = "Y";
          ...
          if ((int) $lastReleaseDate > (int) $reaspektLatestVersion) {
               $isLastVersion = "N";
          }
     ...
     private static function getLastReleaseDate(): string
     {
          ...
          $timestamp = strtotime($arHeaders['last-modified']['values'][0]);
